...
<body>
	<p>
		<a href="join?mid=fall&mname=홍길동&mpassword=12345&mbirth=1995-12-31"
			class="btn btn-primary">get 방식 테스트</a>
		<a href="join2?mid=fall&mname=홍길동&mpassword=12345&mbirth=1995-12-31"
	...
	<form id="joinForm" name="joinForm" method="post" action="join2">
		<div class="input-group mb-3">
			...
			<input id="mid" name="mid" value="fall" type="text" class="form-control"
		...
		<div class="input-group mb-3">
			...
			<input id="mname" name="mname" value="홍길동" type="text" class="form-control"
				placeholder="Username" aria-label="Username"
				aria-describedby="basic-addon1">
		</div>
		...
		<div class="input-group mb-3">
			...
			<input id="mage" name="mage" value="25" type="number" class="form-control"
				placeholder="Username" aria-label="Username"
				aria-describedby="basic-addon1">
		</div>
